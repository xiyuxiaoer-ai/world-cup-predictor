  ...
  return (
    <div className="fixed inset-0 bg-black/30 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-2xl p-6 w-full max-w-sm shadow-xl border border-gray-100 animate-float-up">
        <h2 className="text-lg font-bold text-gray-900 mb-1">邀请成员</h2>
        <p className="text-gray-500 text-sm mb-4">输入对方注册时的用户名</p>
        <form onSubmit={handleInvite} className="space-y-4">
          ...
          <div className="flex gap-3">
            <button type="button" onClick={onClose} className="flex-1 border border-gray-200 text-gray-600 py-2.5 rounded-lg hover:bg-gray-50 transition-colors font-medium">关闭</button>
